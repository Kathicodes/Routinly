...
import FilterModalOption from './Modal-Option';
import TaskDate from '../note/taskForm/Task-Date';
import TaskImportanceInput from '../note/taskForm/Task-Importance-Input';
import InputLabel from '../note/taskForm/InputLabel';
...
const FilterOption = ({ option, filterData, filterDataSetters, setShowFullAddForm }: FilterOptionProps) => {
                    ...
                    <>
                        <div className="fl sm:mb-8 mb-6 justify-center sm:flex-row flex-col">
                            <TaskDate
                                ...
                                inputClassname="border-2 border-solid border-green-100 px-2 rounded-md"
                                isStartDate={true}
                            />
                            <div ref={dateDashRef}>
                        ...
                        {getDateOptions(filterData.oldestTaskDate).map((option) => {
                            return (
                                <FilterModalOption
                    ...
                    <div>
                        <div className="flex-between sm:mb-8 mb-6 sm:mx-6 mx-4">
                            <div className="fl relative">
                                <TaskImportanceInput importance={filterData.importanceMin} setImportance={filterDataSetters.setImportanceMin} inputId="noteImportanceMinFilterOption" />
                            ...
                            <div className="fl relative">
                                <TaskImportanceInput importance={filterData.importanceMax} setImportance={filterDataSetters.setImportanceMax} inputId="noteImportanceMaxFilterOption" />
    ...
    return (
        <div
            ...
            className={`filter-option min-w-[12rem] cursor-pointer relative flex-between mx-3 pl-4 pr-7 py-3 mt-2 flex-1 xs:basis-[15%] basis-full rounded-lg shadow-md text-green-700 transition-all duration-[250ms] ${
                isModalOpened ? '!bg-green-600 !text-white !shadow-lg focused' : ''
        ...
        >
            ...
            <span className={`text-2xl absolute right-2 top-4 text-green-500 filter-arrow transition-all duration-[250ms] ${isModalOpened ? 'opened' : 'closed'}`}>
                <IoIosArrowDown />
            </span>
