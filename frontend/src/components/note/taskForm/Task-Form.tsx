...
const NoteForm = ({ isShort, showFullAddForm, setShowFullAddForm }: NoteFormProps) => {
    ...
    const [color, setColor] = useState<string>('#007c36');
            ...
            >
                <div className="fl border-bottom relative z-10">
                    {!isShort && _id !== '' && (
                        <div className="fl text-gray-400 text-3xl mr-3">
                            <span onClick={handleStarredClick} className={`cursor-pointer transition-colors hover:text-green-600 mr-1 ${isStarred ? 'text-green-500' : ''}`}>
                                <AiFillStar />
                            </span>
                    ...
                    <TextareaAutosize
                        ...
                        className={`font-medium w-full flex-1 sm:pr-20 pr-12 text-green-900 resize-none overflow-hidden ${
                ...
                <div className="fl lg:flex-row flex-col border-bottom-lg-show mb-6">
                    ...
                    <div className="fl border-bottom-lg lg:mt-0 mt-5 w-full justify-between lg:px-0 xs:px-4">
                        <div className="xlg:mx-4 lg:mx-1 sm:ml-2 mr-4 flex-shrink-0 text-lg text-green-600 whitespace-nowrap">{words} words</div>
                ...
                <div>
                    <SaveButton
                        className={`bg-green-600 hover:bg-green-700 disabled:bg-green-900 ${isShort ? 'mt-2 py-2' : 'mt-4'}`}
                        onclick={(e) => {
                            e.preventDefault();
